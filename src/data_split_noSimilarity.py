'''
    for Ablation Study without RNA sequence similarity and disease sematic similarity
'''
...
# save mark_src
with open(graph_pth + 'mark_src_noSim.pkl', 'wb') as f:
    pickle.dump(mask_src, f)

# save train set and test set
graph_labels = {"glabel": torch.tensor([0, 1, 2, 3])}
dgl.save_graphs(graph_pth + 'heterographs_noSim.bin', 
